...
![集計用ラベル作成](./images/集計用ラベル作成.png)

「名前」と「説明」を入力して保存します。既存のラベルを編集する場合は、一覧の「編集」ボタンを押してください。

![集計用ラベル管理(編集)](./images/集計用ラベル管理(編集).png)
...
![集計用ラベル管理(科目設定)](./images/集計用ラベル管理(科目設定).png)

3.  「全科目から選択」のリストの中から、このラベルに含めたい勘定科目にチェックを入れます。

![集計用ラベル管理(科目選択)](./images/集計用ラベル管理(科目選択).png)
...
![集計用ラベル管理(科目選択保存)](./images/集計用ラベル管理(科目選択保存).png)
...
![プロジェクトの集計設定(保存)](./images/プロジェクトの集計設定(保存).png)
...
![プロジェクト(伝票入力との連携)](./images/プロジェクト(伝票入力との連携).png)
...
![プロジェクト集計(その他)](./images/プロジェクト集計(その他).png)`
