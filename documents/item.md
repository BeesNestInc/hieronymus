...
左のメインメニューから「品目管理」を選択すると、登録されている品目が一覧で表示されます。

![品目一覧画面](./images/品目一覧画面.png)

一覧では、品目のクラス（種別）、検索キー、商品名、規格、単価などが確認できます。
画面上部のフィルター機能を使うことで、特定の「クラス」や「検索キー」で品目を絞り込むことができます。

![品目一覧画面(フィルター)](./images/品目一覧画面(フィルター).png)
...
**説明・ファイル**の表示や入力欄は普段は閉じていますが、欄を展開するアイコンをクリックすることで展開します。

![品目入力画面(展開ボタン)](./images/品目入力画面(展開ボタン).png)

![品目入力画面(展開)](./images/品目入力画面(展開).png)

![品目入力画面(説明展開)](./images/品目入力画面(説明展開).png)

**説明・ファイル**の操作については[**説明・ファイル**](説明・ファイル.md)をご覧下さい。

## 品目種別設定

品目を分類するための「種別」を自由に定義・編集するための画面です。
左のメインメニューから「品目管理」>「設定」をクリックすると、設定画面が開きます。

![品目種別設定画面](./images/品目種別設定画面.png)
